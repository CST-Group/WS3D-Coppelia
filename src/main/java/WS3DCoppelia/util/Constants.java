...
public class Constants {
    ...
    public static String BASE_SCRIPT = "#python\n"
            ...
            + "            else:\n"
            + "                sim.setObjectOrientation(agent_handle, target_handle, [agent_err_ori[0], agent_err_ori[1],0.0])\n"
            ...
            + "        simUI.setLabelText(ui, 110, '{:.3f}'.format(ori[2] + 0.00001))\n" //+0.00001 to avoid signal flickering when setting orientation to 0
            ...
            + "    if vel > 0.1:\n"
            + "        vel = 0.02\n"
            + "    sim.setFloatSignal('ang_vel', angVel)\n"
